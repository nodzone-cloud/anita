(function(){
"use strict";
/* ANITA 0.2.4 — ROBUST NEW-BRIEF ESCAPE */
if(window.__ANITA50_BOOTSTRAPPED_024__)return;
window.__ANITA50_BOOTSTRAPPED_024__=true;

const BASE="https://cdn.jsdelivr.net/gh/nodzone-cloud/anita@0d7583505d5439410df369cb58326e7cc835bbcf/anita/anita50/";
const VERSION="024";
const files=[
  "config-v017a.js",
  "state-v017.js",
...
async function boot(){
  try{
    ...
    window.__ANITA_BOOT_FILES_024__=files.slice();
    window.__ANITA_READY_024__={
      humanTech:!!window.ANITA50?.__humanTech022,
      briefFocus:!!window.ANITA50?.__conversationBrief021,
      websiteEntry:!!window.ANITA50?.__websiteEntry020,
      briefReset:!!window.ANITA50?.__briefReset023,
      robustReset:!!window.ANITA50?.__briefReset024,
      semantic:!!window.ANITA50?.semantic,
      ai:!!window.ANITA50?.ai,
      state:!!window.ANITA50?.state
    };
    console.log("[ANITA 0.2.4 ROBUST NEW BRIEF]",window.__ANITA_READY_024__);
  }catch(err){console.error("[ANITA 0.2.4 bootstrap]",err);window.__ANITA_BOOT_ERROR_024__=String(err&&err.message||err);}
}
boot();
})();
