...
/*
 * ANITA 0.1.6.5i — WEBSITE HANDOFF + ADD-ONS
...
if(window.__ANITA50_BOOTSTRAPPED_0165R__) return;
window.__ANITA50_BOOTSTRAPPED_0165R__ = true;
...
async function boot(){
  try{
    ...
    window.__ANITA_BOOT_FILES_0165R__ = files.slice();
    ...
    window.__ANITA_MOUNT_READY_0165R__ = {
    ...
    console.log(
      "[ANITA 0.1.6.5q AI IDENTITY GROUNDING]",
      window.__ANITA_MOUNT_READY_0165R__
    );

  }catch(err){
    console.error("[ANITA 0.1.6.5q bootstrap]", err);
    window.__ANITA_BOOT_ERROR_0165R__ =
