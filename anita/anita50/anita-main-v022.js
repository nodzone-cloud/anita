(function(){
"use strict";
/* ANITA 0.2.2 — HUMAN-TECH CONVERSATION */
if(window.__ANITA50_BOOTSTRAPPED_022__)return;
window.__ANITA50_BOOTSTRAPPED_022__=true;

const BASE="https://cdn.jsdelivr.net/gh/nodzone-cloud/anita@4aa59f21b8cdbfb9e3f08a2c88f0dcb0c4290cec/anita/anita50/";
const VERSION="022";
const files=[
  "config-v017a.js",
  "state-v017.js",
...
async function boot(){
  try{
    ...
    window.__ANITA_BOOT_FILES_022__=files.slice();
    window.__ANITA_READY_022__={
    ...
    console.log("[ANITA 0.2.2 HUMAN-TECH]",window.__ANITA_READY_022__);
  }catch(err){
    console.error("[ANITA 0.2.2 bootstrap]",err);
    window.__ANITA_BOOT_ERROR_022__=String(err&&err.message||err);
  }
}
boot();
})();
