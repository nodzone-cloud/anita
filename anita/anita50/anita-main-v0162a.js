(function(){
if(window.__ANITA50_BOOTSTRAPPED_0162A__) return;window.__ANITA50_BOOTSTRAPPED_0162A__=true;
...
(async()=>{css(B+"anita50.css?v=0162a");mount();for(const f of ["config-v0162a.js","state-v0162a.js","ui.js","actions.js","roles-v0162a.js","ai-bridge-v0162a.js","tour.js","core-v0162a.js"])await js(B+f+"?v=0162a")})().catch(e=>console.error("ANITA50 boot failed",e));
})();
