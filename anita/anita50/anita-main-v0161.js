(function(){
if(window.__ANITA50_BOOTSTRAPPED__) return;window.__ANITA50_BOOTSTRAPPED__=true;
...
(async()=>{css(B+"anita50.css?v=0161");mount();for(const f of ["config-v0161.js","state-v0161.js","ui.js","actions.js","roles-v0161.js","ai-bridge-v0161.js","tour.js","core-v0161.js"])await js(B+f+"?v=0161")})().catch(e=>console.error("ANITA50 boot failed",e));
})();
