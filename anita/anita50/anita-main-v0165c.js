(function(){
if(window.__ANITA50_BOOTSTRAPPED_0165C__) return;window.__ANITA50_BOOTSTRAPPED_0165C__=true;
...
(async()=>{css(B+"anita50.css?v=0165c");mount();for(const f of ["config-v0165c.js","state-v0165c.js","ui.js","actions.js","roles-v0165c.js","ai-bridge-v0165c.js","semantic-v0165c.js","semantic-adapter-v0165c.js","tour.js","core-v0165c.js"])await js(B+f+"?v=0165c")})().catch(e=>console.error("ANITA50 boot failed",e));
})();
