(function(){
"use strict";
/* ANITA 0.3.9 — TYPED BRIEF HANDOFF */
if(window.__ANITA50_BOOTSTRAPPED_039__)return;
window.__ANITA50_BOOTSTRAPPED_039__=true;
const BASE="https://cdn.jsdelivr.net/gh/nodzone-cloud/anita@462efc6781c17f23e76a8a1ce1838c0204201171/anita/anita50/";
const VERSION="039";
const files=[
  "config-v017a.js",
  "state-v017.js",
...
async function boot(){try{await waitForBody();loadCSS(BASE+"anita50.css?v="+VERSION);mount();if(!document.getElementById("an50-root"))throw new Error("ANITA mount failed: #an50-root was not created");for(const file of files)await loadScript(BASE+file+"?v="+VERSION);window.__ANITA_READY_039__={singleRouter:!!window.ANITA50?.router038,core:!!window.ANITA50?.__core034,typedSendBrief:!!window.__ANITA_V039__?.typedSendBrief,explicitSendChoice:!!window.__ANITA_V039__?.explicitSendChoice,explicitBriefHandoff:!!window.__ANITA_V037__?.explicitHandoffChoice,semantic:!!window.ANITA50?.semantic,ai:!!window.ANITA50?.ai,state:!!window.ANITA50?.state};console.log("[ANITA 0.3.9 TYPED BRIEF HANDOFF]",window.__ANITA_READY_039__);}catch(err){console.error("[ANITA 0.3.9 bootstrap]",err);window.__ANITA_BOOT_ERROR_039__=String(err&&err.message||err);}}
boot();
})();