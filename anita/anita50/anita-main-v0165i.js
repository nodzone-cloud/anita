...
if(window.__ANITA50_BOOTSTRAPPED_0165I__) return;
window.__ANITA50_BOOTSTRAPPED_0165I__ = true;
...
async function boot(){
  try{
    ...
    window.__ANITA_BOOT_FILES_0165I__ = files.slice();
    ...
    window.__ANITA_MOUNT_READY_0165I__ = {
    ...
    window.__ANITA_BOOT_ERROR_0165I__ =
