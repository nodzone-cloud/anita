...
/*
 * ANITA 0.1.6.5i — SECRETARY CONTEXT BOUNDARY
...
if(window.__ANITA50_BOOTSTRAPPED_0165O__) return;
window.__ANITA50_BOOTSTRAPPED_0165O__ = true;
...
async function boot(){
  try{
    ...
    window.__ANITA_BOOT_FILES_0165O__ = files.slice();
    ...
    window.__ANITA_MOUNT_READY_0165O__ = {
    ...
    window.__ANITA_BOOT_ERROR_0165O__ =
