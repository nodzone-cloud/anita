...
if(window.__ANITA50_BOOTSTRAPPED_0165Q__) return;
window.__ANITA50_BOOTSTRAPPED_0165Q__ = true;
...
async function boot(){
  try{
    ...
    window.__ANITA_BOOT_FILES_0165Q__ = files.slice();
    ...
    window.__ANITA_MOUNT_READY_0165Q__ = {
    ...
    console.log(
      "[ANITA 0.1.6.5q LOADER FIX]",
      window.__ANITA_MOUNT_READY_0165Q__
    );

  }catch(err){
    console.error("[ANITA 0.1.6.5q bootstrap]", err);
    window.__ANITA_BOOT_ERROR_0165Q__ =
