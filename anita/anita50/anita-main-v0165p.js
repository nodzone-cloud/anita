...
if(window.__ANITA50_BOOTSTRAPPED_0165P__) return;
window.__ANITA50_BOOTSTRAPPED_0165P__ = true;
...
async function boot(){
  try{
    ...
    window.__ANITA_BOOT_FILES_0165P__ = files.slice();
    ...
    window.__ANITA_MOUNT_READY_0165P__ = {
    ...
    window.__ANITA_BOOT_ERROR_0165P__ =
