(function(){
if(window.__ANITA50_BOOTSTRAPPED_0165E__) return;window.__ANITA50_BOOTSTRAPPED_0165E__=true;
...
(async()=>{css(B+"anita50.css?v=0165e");mount();for(const f of ["config-v0165e.js","state-v0165e.js","ui.js","actions.js","roles-v0165e.js","ai-bridge-v0165e.js","semantic-v0165e.js","semantic-adapter-v0165e.js","tour.js","core-v0165e.js"])await js(B+f+"?v=0165e")})().catch(e=>console.error("ANITA50 boot failed",e));
})();
