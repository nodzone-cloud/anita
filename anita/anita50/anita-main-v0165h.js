(function(){
"use strict";
if(window.__ANITA50_BOOTSTRAPPED_0165H__) return;
window.__ANITA50_BOOTSTRAPPED_0165H__=true;
...
(async function(){
  try{
    ...
    window.__ANITA_BOOT_FILES_0165H__=files.slice();
    ...
    console.error("[ANITA 0.1.6.5h bootstrap]",err);
    window.__ANITA_BOOT_ERROR_0165H__=String(err&&err.message||err);
  }
})();
})();