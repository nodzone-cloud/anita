(function(){
if(window.__ANITA50_BOOTSTRAPPED_0164__) return;window.__ANITA50_BOOTSTRAPPED_0164__=true;
...
(async()=>{css(B+"anita50.css?v=0164");mount();for(const f of ["config-v0164.js","state-v0164.js","ui.js","actions.js","roles-v0164.js","ai-bridge-v0164.js","tour.js","core-v0164.js"])await js(B+f+"?v=0164")})().catch(e=>console.error("ANITA50 boot failed",e));
})();
