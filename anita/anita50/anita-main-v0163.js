(function(){
if(window.__ANITA50_BOOTSTRAPPED_0163__) return;window.__ANITA50_BOOTSTRAPPED_0163__=true;
...
(async()=>{css(B+"anita50.css?v=0163");mount();for(const f of ["config-v0163.js","state-v0163.js","ui.js","actions.js","roles-v0163.js","ai-bridge-v0163.js","tour.js","core-v0163.js"])await js(B+f+"?v=0163")})().catch(e=>console.error("ANITA50 boot failed",e));
})();
