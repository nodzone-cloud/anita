...
(async()=>{css(B+"anita50.css?v=016");mount();for(const f of ["config-v016.js","state-v016.js","ui.js","actions.js","roles-v016.js","ai-bridge-v016.js","tour.js","core-v016.js"])await js(B+f+"?v=016")})().catch(e=>console.error("ANITA50 boot failed",e));
})();
