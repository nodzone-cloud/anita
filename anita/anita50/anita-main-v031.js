(function(){
"use strict";
/* ANITA 0.3.1 — HUMAN-TECH TURN AWARE */
if(window.__ANITA50_BOOTSTRAPPED_031__)return;
window.__ANITA50_BOOTSTRAPPED_031__=true;

const BASE="https://cdn.jsdelivr.net/gh/nodzone-cloud/anita@fa44667c0eb70af07c373242d30d8ce2b7f6029c/anita/anita50/";
const VERSION="031";
const files=[
  "config-v017a.js",
  "state-v017.js",
...
async function boot(){
  try{
    ...
    window.__ANITA_READY_031__={
      ...
      socialTurnAwareness:!!window.__ANITA_V031__?.socialTurnAwareness,
      semantic:!!window.ANITA50?.semantic,
      ai:!!window.ANITA50?.ai,
      state:!!window.ANITA50?.state
    };
    console.log("[ANITA 0.3.1 HUMAN-TECH TURN AWARE]",window.__ANITA_READY_031__);
  }catch(err){
    console.error("[ANITA 0.3.1 bootstrap]",err);
    window.__ANITA_BOOT_ERROR_031__=String(err&&err.message||err);
  }
}
boot();
})();