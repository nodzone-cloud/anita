(function(){
"use strict";
/* ANITA 0.2.3 — NEW BRIEF ANYTIME */
if(window.__ANITA50_BOOTSTRAPPED_023__)return;
window.__ANITA50_BOOTSTRAPPED_023__=true;

const BASE="https://cdn.jsdelivr.net/gh/nodzone-cloud/anita@b09a4a5219ffc83be46e607d76ac2e68be98dced/anita/anita50/";
const VERSION="023";
const files=[
  "config-v017a.js",
  "state-v017.js",
...
async function boot(){
  try{
    ...
    window.__ANITA_BOOT_FILES_023__=files.slice();
    window.__ANITA_READY_023__={
    ...
    console.log("[ANITA 0.2.3 NEW BRIEF ANYTIME]",window.__ANITA_READY_023__);
  }catch(err){
    console.error("[ANITA 0.2.3 bootstrap]",err);
    window.__ANITA_BOOT_ERROR_023__=String(err&&err.message||err);
  }
}
boot();
})();
