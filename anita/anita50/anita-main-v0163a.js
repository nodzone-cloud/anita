(function(){
if(window.__ANITA50_BOOTSTRAPPED_0163A__) return;window.__ANITA50_BOOTSTRAPPED_0163A__=true;
...
(async()=>{css(B+"anita50.css?v=0163a");mount();for(const f of ["config-v0163a.js","state-v0163a.js","ui.js","actions.js","roles-v0163a.js","ai-bridge-v0163a.js","tour.js","core-v0163a.js"])await js(B+f+"?v=0163a")})().catch(e=>console.error("ANITA50 boot failed",e));
})();
