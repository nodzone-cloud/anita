...
/*
 * ANITA 0.1.6.5i — CONVERSATIONAL PRIORITY
...
if(window.__ANITA50_BOOTSTRAPPED_0165N__) return;
window.__ANITA50_BOOTSTRAPPED_0165N__ = true;
...
async function boot(){
  try{
    ...
    window.__ANITA_BOOT_FILES_0165N__ = files.slice();
    ...
    window.__ANITA_MOUNT_READY_0165N__ = {
    ...
    window.__ANITA_BOOT_ERROR_0165N__ =
