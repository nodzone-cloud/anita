/* ANITA 0.1.7 — core using delegated controls from v0166b */
(function(){
...
function boot(){
  // Bind at document level so ANITA controls may be created now or later.
  // No dependency on #an50-send/#an50-input existing at boot time.
  ...
  if(home()){
    ...
    // Important: create the normal chat UI first.
    W.ui.ready();
  }

  window.__ANITA_UI_READY_017__={
