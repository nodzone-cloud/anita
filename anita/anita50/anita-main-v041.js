(function(){
"use strict";
/* ANITA 0.4.2 — HUMAN-TECH CONTEXTUAL CONVERSATION */
...
const VERSION="042-human-tech-20260917";
const files=[
  ...
  "core-v034.js","brief-confirm-v037.js","brief-text-commands-v039.js","contextual-resolver-v042.js"
];
...
async function boot(){try{await waitForBody();loadCSS(BASE+"anita50.css?v="+VERSION);mount();if(!document.getElementById("an50-root"))throw new Error("ANITA mount failed: #an50-root was not created");for(const file of files)await loadScript(BASE+file+"?v="+VERSION);window.__ANITA_READY_041__={humanTechContext:!!window.__ANITA_V042__?.contextualAnswers,choiceButtons:!!window.__ANITA_V042__?.briefChoiceButtons,sizeUnderstanding:!!window.__ANITA_V041__?.sizeUnderstanding,semantic:!!window.ANITA50?.semantic,ai:!!window.ANITA50?.ai,state:!!window.ANITA50?.state};console.log("[ANITA 0.4.2 HUMAN-TECH]",window.__ANITA_READY_041__);}catch(err){console.error("[ANITA 0.4.2 bootstrap]",err);window.__ANITA_BOOT_ERROR_041__=String(err&&err.message||err);}}
boot();
})();