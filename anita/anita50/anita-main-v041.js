...
const BASE="https://cdn.jsdelivr.net/gh/nodzone-cloud/anita@d8f27854ea1aefc2c5d27151a5bdc02195a0d064/anita/anita50/";
const VERSION="041-fix1";
const files=[
  "config-v017a.js",
  "state-v017.js",
  "ui.js",
...
async function boot(){try{await waitForBody();loadCSS(BASE+"anita50.css?v="+VERSION);mount();if(!document.getElementById("an50-root"))throw new Error("ANITA mount failed: #an50-root was not created");for(const file of files)await loadScript(BASE+file+"?v="+VERSION);window.__ANITA_READY_041__={singleRouter:!!window.ANITA50?.router038,core:!!window.ANITA50?.__core034,openBriefLanguage:!!window.__ANITA_V041__?.openBriefLanguage,contextFirstRouting:!!window.__ANITA_V041__?.contextFirstRouting,semanticGoalUnderstanding:!!window.__ANITA_V041__?.semanticGoalUnderstanding,naturalConfirmations:!!window.__ANITA_V041__?.naturalConfirmations,sizeUnderstanding:!!window.__ANITA_V041__?.sizeUnderstanding,confirmedSalesGuard:!!window.__ANITA_V041__?.confirmedSalesGuard,typedSendBrief:!!window.__ANITA_V039__?.typedSendBrief,explicitBriefHandoff:!!window.__ANITA_V037__?.explicitHandoffChoice,semantic:!!window.ANITA50?.semantic,ai:!!window.ANITA50?.ai,state:!!window.ANITA50?.state};console.log("[ANITA 0.4.1 FIX1]",window.__ANITA_READY_041__);}catch(err){console.error("[ANITA 0.4.1 bootstrap]",err);window.__ANITA_BOOT_ERROR_041__=String(err&&err.message||err);}}
boot();
})();