 ...
 * Clean architecture: one central router + one core dispatcher.
 * Previous v024 remains untouched as rollback.
 */
if(window.__ANITA50_BOOTSTRAPPED_030__)return;
window.__ANITA50_BOOTSTRAPPED_030__=true;

const BASE="https://cdn.jsdelivr.net/gh/nodzone-cloud/anita@6b09755288e617933e3ba38281b905c9019cbc51/anita/anita50/";
const VERSION="030";
const files=[
  "config-v017a.js",
  "state-v017.js",
...
async function boot(){
  try{
    ...
    window.__ANITA_BOOT_FILES_030__=files.slice();
    window.__ANITA_READY_030__={
      singleRouter:!!window.ANITA50?.router030,
      core:!!window.ANITA50?.__core030,
      semantic:!!window.ANITA50?.semantic,
      ai:!!window.ANITA50?.ai,
      state:!!window.ANITA50?.state
    };
    console.log("[ANITA 0.3.0 HUMAN-TECH CORE]",window.__ANITA_READY_030__);
  }catch(err){
    console.error("[ANITA 0.3.0 bootstrap]",err);
    window.__ANITA_BOOT_ERROR_030__=String(err&&err.message||err);
  }
}
boot();
})();