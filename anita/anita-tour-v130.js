(function(){
  ...
  W.tour = {
    ...
    async resume(){
      ...
      /* v1.3.0: pending ticket is useful but not required.
         If the active tour's current step belongs to THIS page, restore its controls.
         We never redirect here, so manual navigation remains safe. */
      consumePendingForCurrentPage(s.step);
    ...
    stop(){
      ...
      setTimeout(()=>W.ui.showBubble("Tour stopped 😊 You can keep asking me questions normally.",{autoHide:false}),60);
    },
    ...
    finish(){
      ...
      setTimeout(()=>{
        ...
        W.ui.showBubble("Tour finished 😊 You can keep talking to me normally.",{autoHide:false});
      },60);
    }
  };
